...
For the 6 boxplots, we have found that when someone comes out or is engaged with the LGBT community, they are, on average, happier than those who do not come out or attend. Also those who come out feel more support and less prejudice for being LGBT. The models show that coming out is a good experience and has a positive effect in the LGBT individual's life. 

There were some limitations to the data and research conducted. The survey was based on feelings and thoughts. It is hard to judge an neighborhoods of homophobic actions if there is no proof of it. Also, a family member being supportive is hard to really see because humans have become good at hiding their true emotions or intentions. Yoou can not base merely off of feelings.

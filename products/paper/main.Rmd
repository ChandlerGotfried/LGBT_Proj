...
ggplot(sjsd, aes(x=out_neighbors, y=happiness))+
  ...
  labs(x="Coming out to neighbors", y="Happiness", title="Boxplot of coming out to neighbors and happiness")+
  coord_flip()+
  theme_bw()
```
...
ggplot(sjsd, aes(x=event, y=lgbt_bond))+
  ...
  labs(y="Bond felt with LGBT community", x="Participates with LGBT events", title="Boxplot of LGBT events attended and\nthe bond felt with LGBT community")+
  coord_flip()+
  theme_bw()
```
...
ggplot(sjsd, aes(x=event, y=happiness))+
  geom_boxplot(fill="red", outlier.color = "green", varwidth = TRUE)+
  labs(x="Events attended", y="Happiness", title="Boxplot of happiness expereinced from attending an event")+
  coord_flip()+
  theme_bw()
```
